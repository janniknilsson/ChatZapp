...
(function ($, window) {
    ...
    signalR.hub = {
        start: function () {
            // This will GetAll replaced with the real hub connection start method when hubs is referenced correctly
    ...
    function checkIfAlive(connection) {
        ...
        if (connection.state === signalR.connectionState.connected) {
            ...
            if (timeElapsed >= keepAliveData.timeout) {
                ...
                // This is to assure that the user only GetAlls a single warning
                    ...
                    (function poll(instance, raiseReconnect) {
                        ...
                        instance.pollXhr = $.ajax({
                            ...
                            error: function (data, textStatus) {
                                ...
                                // This will ping the server until it successfully GetAlls a response.
